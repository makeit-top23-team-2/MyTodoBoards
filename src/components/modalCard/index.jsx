      ...
      <main className='modal__card'>
        ...
        <section className='modal__section'>
          ...
          <div>
            {
              ...
              (tasks.map(item => (
                <div key={item.id} className='modal__section__div'>
                  ...
                  <button className='modal__section__button' type='submit' onClick={() => handleDelete(item.id)}>Delete</button>
                </div>
              ))
              )
            }
          ...
          <form onSubmit={handleSubmit}>  
            ...
            />
            <button disabled={task.description ? '' : "disabled"} type='submit' className='modal__section__button'>Add an Item</button>
          </form>
        </section>
        ...
        <aside className='modal__aside'>
          ...
          <div className='modal__aside__div'>
            ...
            <button type='button' className='modal__aside__button' onClick={handleClick}>
              <span className="modal__aside__span">Checklist</span>
            </button>

            <button type='button' className='modal__section__delete'>Delete Card</button>
          </div>
        </aside>
        <ModalChecklist modalChecklist={modalChecklist} setModalCheclist={setModalCheclist}/> 
      </main>   
    </div>
      )}
    </div>,
