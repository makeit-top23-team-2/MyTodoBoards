    ...
    <div>
      ...
      <section className='check'>
        <header className='check__header'>
          ...
          <button type='button' className='check__button' onClick={handleModal}>
        ...
        <main className='check__main'>
          <form onSubmit={handleSubmit}>
            ...
            <input type="text" value={title} className='check__input' onChange={handleChange}/>
            <button type='submit' className='check__form__button' >Add</button>
          </form>
        </main>
      </section>
      }
